package br.lista.dao;

import br.lista.factory.ConnectionFactory;
...
public class ListaDao {
    ...
    public ListaDao() {
        try {
            ...
            System.out.println("Problema ao conectar ao banco de dados - " + e.getMessage());
    ...
    private void createTableIfExists(){
        ...
        try {
            ...
            System.err.println("Problema ao criar tabela - " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    private boolean isValidoTituloLista(Lista lista){
        ...
        if (lista.getTitulo().isEmpty()){
            System.err.println("Titulo da lista vaio");
            return false;
        }
        return true;
    }
    ...
    public void create(Lista lista) {
        if(!isValidoTituloLista(lista)){
            throw new RuntimeException("Lista inexistente");
        }
        ...
        try {
            ...
            System.err.println("Problema ao incluir lista - " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public Lista readOne(int idLista){
        ...
        try {
            ...
            System.err.println("Problmea ao buscar lista - " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public ArrayList<Lista> readAll() {
        ...
        try {
            ...
            System.err.println("Problema ao acessar lista: " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public void update(Lista lista) {
        ...
        try {
            ...
            System.err.println("Problmea ao atualizar lista - " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public void delete(int idLista) {
        ...
        try {
            ...
            System.err.println("Problema ao deletar lista - " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
    ...
    public int getIdByTitulo(String titulo) {
        ...
        try {
            ...
            System.err.println("Problema ao buscar id da lista - " + e.getMessage());
            throw new RuntimeException(e.getMessage());
        }
    }
